        ...
        <script type="text/javascript">
          ...
          function drawChart() {
             ...
             foreach ($vistacita as $vistacita){
               ...
               $vistaEnfermedad=DB::table('vistaenfermedad')->select(DB::raw('sum(cantidad) as cantidad, nombreenfermedad'))->where('ano','=', $anoconsulta)->groupBy('nombreenfermedad')->get();
                //dd($vistaEnfermedad);
                ?>
            ...
            data3.addColumn('number', 'Cantidad Enfermedades');
            ...
            // Set chart options
            var options = {'title':'cantidad de Enfermedades en el año',
                           'width':400,
                           'height':300};
            // Set chart options
            var options2 = {'title':'How Much Pizza You Ate Last Night',
                           ...
                           'height':300};
            // Set chart options
            var options3 = {'title':'Cantidad total de Enfermedades por mes',
                           'width':900,
                           'height':500};
