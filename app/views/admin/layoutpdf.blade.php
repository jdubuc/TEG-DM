    ...
    <![endif]-->
        ...
        <script type="text/javascript">
          ...
          function drawChart() {
                ...
                //$citac= Cita::get()->orderBy('fecha_cita');
                $citac= DB::table('citas')->orderBy('fecha_cita', 'desc')->get();
                $vistacita = DB::table('vistacita')->where('ano','=',  $ano2)->get();
                //echo $resultcit;
                //echo $resultcit;
                ...
                foreach ($citac as $citac){
                  ...
                  if($citac->estado==3)
                        {$cita3++;}
                      $fechacita=explode("-", $citac->fecha_cita);
            ...
            data3.addRows([
              ...
              ['1', <?php echo $enero ?>, <?php echo $eneroR ?>],
              ['2', <?php echo $febrero ?>, <?php echo $febreroR ?>],
              ['3', <?php echo $marzo ?>, <?php echo $marzoR ?>],
              ['4', <?php echo $abril ?>, <?php echo $abrilR ?>],
              ['5', <?php echo $mayo ?>, <?php echo $mayoR ?>],
              ['6',  <?php echo $junio ?>, <?php echo $junioR ?>],
              ['7', <?php echo $julio ?>, <?php echo $julioR ?>],
              ['8', <?php echo $agosto ?>, <?php echo $agostoR ?>],
              ['9',  <?php echo $septiembre ?>, <?php echo $septiembreR ?>],
              ['10', <?php echo $octubre ?>, <?php echo $octubreR ?>],
              ['11', <?php echo $noviembre ?>, <?php echo $noviembreR ?>],
              ['12', <?php echo $diciembre ?>, <?php echo $diciembreR ?>]
            ]);
  ...
  <body>
    ...
    <div id="wrap">
      ...
      date_default_timezone_set("America/New_York"); 
                    echo "La fecha es: " . date("m/d/Y"); echo $ano2; ?> <br>  <?php 
