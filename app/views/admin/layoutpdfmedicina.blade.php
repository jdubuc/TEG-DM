        ...
        <script type="text/javascript">
          ...
          function drawChart() {
             ...
             foreach ($vistacita as $vistacita){
               ...
               $vistaEnfermedad=DB::table('vistamedicina')->select(DB::raw('sum(cantidad) as cantidad, compuesto'))->where('ano','=', $anoconsulta)->groupBy('compuesto')->get();
                //var_dump($vistaEnfermedad);
                ?>
            ...
            data3.addColumn('number', 'Cantidad medicinas');
            ...
            // Set chart options
            var options = {'title':'cantidad de medicinas en el año',
                           'width':400,
                           'height':300};
            // Set chart options
            var options2 = {'title':'How Much Pizza You Ate Last Night',
                           ...
                           'height':300};
            // Set chart options
            var options3 = {'title':'Cantidad total de medicinas por mes',
                           'width':900,
                           'height':500};
