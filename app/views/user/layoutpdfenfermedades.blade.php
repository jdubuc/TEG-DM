        ...
        <script type="text/javascript">
          ...
          function drawChart() {
             ...
             foreach ($vistacita as $vistacita){
               ...
               $vistaEnfermedad=DB::table('vistaenfermedad')->select(DB::raw('sum(cantidad) as cantidad, nombreenfermedad'))->where('iduser','=', $id)->where('ano','=', $anoconsulta)->groupBy('nombreenfermedad')->get();
                ?>
